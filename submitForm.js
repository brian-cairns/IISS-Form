...
selfInjury1.addEventListener('click', (e) => {
    newForm.selfInjury = getElementById('selfInjuryText1')
...
selfInjury2.addEventListener('click', (e) => {
    newForm.selfInjury = getElementById('selfInjuryText2')
...
selfInjury3.addEventListener('click', (e) => {
    newForm.selfInjury = getElementById('selfInjuryText3')
...
selfInjury4.addEventListener('click', (e) => {
    newForm.selfInjury = getElementById('selfInjuryText4')
...
selfInjury5.addEventListener('click', (e) => {
    newForm.selfInjury = getElementById('selfInjuryText5')
...
reportable1.addEventListener('click', (e) => {
    newForm.reportable = getElementById('reportableText1')
...
reportable2.addEventListener('click', (e) => {
    newForm.reportable = getElementById('reportableText2')
...
reportable3.addEventListener('click', (e) => {
    newForm.reportable = getElementById('reportableText3')
...
reportable4.addEventListener('click', (e) => {
    newForm.reportable = getElementById('reportableText4')
...
reportable5.addEventListener('click', (e) => {
    newForm.reportable = getElementById('reportableText5')
...
aggressive1.addEventListener('click', (e) => {
    newForm.aggressive = getElementById('aggressiveText1')
...
aggressive2.addEventListener('click', (e) => {
    newForm.aggressive = getElementById('aggressiveText2')
...
aggressive3.addEventListener('click', (e) => {
    newForm.aggressive = getElementById('aggressiveText3')
...
aggressive4.addEventListener('click', (e) => {
    newForm.aggressive = getElementById('aggressiveText4')
...
aggressive5.addEventListener('click', (e) => {
    newForm.aggressive = getElementById('aggressiveText5')
...
compliance1.addEventListener('click', (e) => {
    newForm.compliance = getElementById('complianceText1')
...
compliance2.addEventListener('click', (e) => {
    newForm.compliance = getElementById('complianceText2')
...
compliance4.addEventListener('click', (e) => {
    newForm.compliance = getElementById('complianceText4')
...
compliance5.addEventListener('click', (e) => {
    newForm.compliance = getElementById('complianceText5')
